...
export PREFETCH_DIST=4

export CROSS_DISTANCE_LIMIT=100

export SEED_ROW=50

export CACHE_CAPACITY=256

export FRONTIER_SIZE=10000
...
dlmc_matrices_files=(
    ...
    "$path_dlmc/transformer_matrices_small_onlyencoder_onlymagnitude.txt"
